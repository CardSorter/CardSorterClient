...
export const changeView = createAction<{ no: number }>("studyPage/changeView");
...
export const loadStudy = createAction<{ status: string, study?: any, error: boolean }>("studyPage/loadStudy");
